...
for num in range(5000):
    try:
        ...
        os.system('./halite -d "240 160" "python3 splinter.py" "python3 splinter2.py" > data.gameout')
        ...
        with open('data.gameout', 'r') as f:
            ...
            print("Splinter rank: {} ships: {} dmg: {}".format(CharlesBot1_rank,CharlesBot1_ships,CharlesBot1_dmg))
            print("Splinter2 rank: {} ships: {} dmg: {}".format(CharlesBot2_rank,CharlesBot2_ships,CharlesBot2_dmg))
